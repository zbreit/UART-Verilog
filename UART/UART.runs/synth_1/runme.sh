...
HD_PWD='C:/Users/zbrei/Documents/UMD-Schoolwork/ENEE459V/UART/UART.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Tx.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Tx.tcl
