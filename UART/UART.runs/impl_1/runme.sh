...
HD_PWD='C:/Users/zbrei/Documents/UMD-Schoolwork/ENEE459V/UART/UART.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Tx.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Tx.tcl -notrace
